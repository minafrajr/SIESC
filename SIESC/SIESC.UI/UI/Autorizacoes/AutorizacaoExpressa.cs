...
namespace SIESC.UI.UI.Autorizacoes
{
	...
	public partial class AutorizacaoExpressa : BaseUi
	{
		...
		private Autorizacao CriaAutorizacao()
		{
			...
			var autoriz = new Autorizacao(idInstituicao: (int)cbo_instituicao.SelectedValue, idFuncionario: (int)controleFuncionario.PesquisaID(cpf: msk_cpf.Text), dataExpedicao: DateTime.Now, tipoAutoriz: tipoAutoriz, false);

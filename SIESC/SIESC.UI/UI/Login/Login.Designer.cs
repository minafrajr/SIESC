...
namespace SIESC.UI.UI.Login
{
	partial class Login
	{
		...
		{
			this.llb_esqueci_senha = new System.Windows.Forms.LinkLabel();
			...
			// llb_esqueci_senha
			// 
			this.llb_esqueci_senha.AutoSize = true;
			this.llb_esqueci_senha.Location = new System.Drawing.Point(174, 188);
			this.llb_esqueci_senha.Name = "llb_esqueci_senha";
			this.llb_esqueci_senha.Size = new System.Drawing.Size(116, 14);
			this.llb_esqueci_senha.TabIndex = 4;
			this.llb_esqueci_senha.TabStop = true;
			this.llb_esqueci_senha.Text = "Esqueci minha Senha";
			this.llb_esqueci_senha.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.llb_mudarsenha_LinkClicked);
			// 
			// btn_cancelar
			// 
			...
			this.Controls.Add(this.llb_esqueci_senha);
		...
		private System.Windows.Forms.LinkLabel llb_esqueci_senha;
	}
}

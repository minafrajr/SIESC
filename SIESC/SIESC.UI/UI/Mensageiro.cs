...
#if !DEBUG
			MessageBox.Show(form, $@"Houve o seguinte erro:{Environment.NewLine} {Environment.NewLine} {exception.Message}{Environment.NewLine}", @"ERRO!", MessageBoxButtons.OK, MessageBoxIcon.Error);
#else

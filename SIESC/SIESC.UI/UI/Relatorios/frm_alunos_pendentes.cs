...
namespace SIESC.UI.UI.Relatorios
{
	...
	public partial class frm_alunos_pendentes : BaseUi
	{
		/// <summary>
		...
		/// <summary>
		/// A orientação da página do relatório
		/// </summary>
				...
				switch (_tipoConsulta)
				{
					case TipoConsulta.regional_ano_escola:
						dt = vw_alunos_pendentesTableAdapter1.GetDataByRegionalAnoEscola(cbo_anoensino.SelectedValue.ToString(),
							cbo_regionais.SelectedValue.ToString(),cbo_escola.SelectedValue.ToString(),anoReferencia);
						break;
					...
					case TipoConsulta.ano:
						dt = vw_alunos_pendentesTableAdapter1.GetDataByAno(cbo_anoensino.SelectedValue.ToString(),anoReferencia);
						break;
					case TipoConsulta.escola:
						dt = vw_alunos_pendentesTableAdapter1.GetDataByEscola(cbo_escola.SelectedValue.ToString(),anoReferencia);
						break;
					...
					case TipoConsulta.regional:
						...
						if (nivel_ensino == 1)
							dt = vw_alunos_pendentesTableAdapter1.GetDataByRegionalInfantil(cbo_regionais.SelectedValue.ToString(),anoReferencia);
						else
						{
							dt = nivel_ensino == 2 ? vw_alunos_pendentesTableAdapter1.GetDataByRegionalFundamental(cbo_regionais.SelectedValue.ToString(),anoReferencia) : vw_alunos_pendentesTableAdapter1.GetDataByRegionalGeral(cbo_regionais.SelectedValue.ToString(),anoReferencia);
						}
						break;
					...
					case TipoConsulta.geral:
						if (nivel_ensino == 1)
							dt = this.vw_alunos_pendentes_infantilTableAdapter1.GetDataBy(anoReferencia);
						else
						{
							if (nivel_ensino == 2)
								dt = this.vw_alunos_pendentes_municipalTableAdapter1.GetDataBy(anoReferencia);
							else
								dt = this.vw_alunos_pendentesTableAdapter1.GetDataBy(anoReferencia);
						}
						break;
					case TipoConsulta.data:
						...
						{
							rpt_viewer.LocalReport.ReportPath = PathRelatorio + "\\Infantil\\rpt_alunos_pendentes_infantil.rdlc";
							dt = vw_alunos_pendentes_infantilTableAdapter1.GetDataOrderByDataSolicitacao(anoReferencia);
						}
						if (nivel_ensino == 2)
						{
							rpt_viewer.LocalReport.ReportPath = PathRelatorio + "\\Fundamental\\rpt_pendentes_municipal.rdlc";
							dt = this.vw_alunos_pendentes_municipalTableAdapter1.GetDataOrderByDataSolicitacao(anoReferencia);
						}
						if (nivel_ensino == 3)
						{
							rpt_viewer.LocalReport.ReportPath = PathRelatorio + "\\Geral\\rpt_Alunos_Pendentes.rdlc";

							dt = vw_alunos_pendentesTableAdapter1.GetDataOrderByDataSolicitacao(anoReferencia);
						}
						break;
				}

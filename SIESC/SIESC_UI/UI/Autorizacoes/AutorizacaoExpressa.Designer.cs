namespace SIESC_UI.UI.Autorizacoes
{
	partial class AutorizacaoExpressa
	{
		...
		private void InitializeComponent()
		{
			...
			this.cargos1TableAdapter1 = new SIESC_UI.siescDataSetTableAdapters.cargos1TableAdapter();
			this.cargosTableAdapter1 = new SIESC_UI.siescDataSetTableAdapters.cargosTableAdapter();
			this.siescDataSet1BindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.disciplinasTableAdapter1 = new SIESC_UI.siescDataSetTableAdapters.disciplinasTableAdapter();

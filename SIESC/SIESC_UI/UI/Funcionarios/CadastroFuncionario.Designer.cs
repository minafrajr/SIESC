namespace SIESC_UI.UI.Funcionarios
{
	partial class CadastroFuncionario
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbo_cargoatual = new SIESC_UI.MyComboBox();
			...
			this.cbo_instituicao = new SIESC_UI.MyComboBox();
			...
			this.cbo_cargoorigem = new SIESC_UI.MyComboBox();
			this.cargosBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.lbl_cargo = new System.Windows.Forms.Label();
			this.txt_email = new SIESC_UI.MyTextBox();
			this.lbl_email = new System.Windows.Forms.Label();
			this.msk_tel3 = new SIESC_UI.MyMaskedTextBox();
			this.msk_tel2 = new SIESC_UI.MyMaskedTextBox();
			this.msk_tel1 = new SIESC_UI.MyMaskedTextBox();
			this.lbl_telefones = new System.Windows.Forms.Label();
			this.txt_cartident = new SIESC_UI.MyTextBox();
			...
			this.msk_cpf = new SIESC_UI.MyMaskedTextBox();
			this.txt_nome = new SIESC_UI.MyTextBox();
			...
			this.txt_bairro = new SIESC_UI.MyTextBox();
			this.txt_complemento = new SIESC_UI.MyTextBox();
			this.lbl_complemento = new System.Windows.Forms.Label();
			this.btn_buscarcep = new System.Windows.Forms.Button();
			this.txt_numresid = new SIESC_UI.MyTextBox();
			this.txt_cidade = new SIESC_UI.MyTextBox();
			this.txt_logradouro = new SIESC_UI.MyTextBox();
			this.cbo_tipolograd = new SIESC_UI.MyComboBox();
			...
			this.cargosTableAdapter = new SIESC_UI.siescDataSetTableAdapters.cargosTableAdapter();
			this.cargos1TableAdapter = new SIESC_UI.siescDataSetTableAdapters.cargos1TableAdapter();
			...
			// 
			this.btn_limpar_cbo_cargoAtual.Image = global::SIESC_UI.Properties.Resources.bullet_delete;
			...
			// 
			this.btn_limpar_cbo_cargoOrigem.Image = global::SIESC_UI.Properties.Resources.bullet_delete;
			...
			this.panel1.Controls.Add(this.lbl_numautoriz);
			this.panel1.Location = new System.Drawing.Point(569, 18);
			...
			this.lbl_codigofunc.Location = new System.Drawing.Point(135, 16);
			...
			this.lbl_numautoriz.Location = new System.Drawing.Point(13, 17);
			this.lbl_numautoriz.Name = "lbl_numautoriz";
			this.lbl_numautoriz.Size = new System.Drawing.Size(0, 23);
			...
			this.btn_autorizar.Image = global::SIESC_UI.Properties.Resources._1431675996_mypc_ok;

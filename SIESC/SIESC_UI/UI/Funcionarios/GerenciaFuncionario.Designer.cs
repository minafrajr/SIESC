namespace SIESC_UI.UI.Funcionarios
{
	partial class GerenciaFuncionario
	{
		...
		private void InitializeComponent()
		{
			...
			this.txt_telefone2 = new SIESC_UI.MyTextBox();
			this.txt_telefone1 = new SIESC_UI.MyTextBox();
			...
			this.txt_autoriz = new SIESC_UI.MyTextBox();
			...
			this.cbo_cargoAtual.Items.AddRange(new object[] {
			"DIRETOR",
			"VICE-DIRETOR",
			"SECRETÁRIO ESCOLAR"});
			...
			this.cbo_cargoOrigem.Items.AddRange(new object[] {
			"PEDAGOGO",
			"PROFESSOR PI",
			"PROFESSOR PII",
			"TÉC. SECRETARIA",
			...
			this.btn_editarAutorizacao.Image = global::SIESC_UI.Properties.Resources._1431675996_mypc_ok;

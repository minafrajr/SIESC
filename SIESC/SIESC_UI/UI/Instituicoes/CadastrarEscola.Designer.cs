namespace SIESC_UI.UI
{
	partial class CadastrarEscola
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbo_regional_adm = new SIESC_UI.MyComboBox();
			...
			this.cbo_mantenedor = new SIESC_UI.MyComboBox();
			...
			this.txt_numero_resid = new SIESC_UI.MyTextBox();
			this.label7 = new System.Windows.Forms.Label();
			this.txt_logradouro = new SIESC_UI.MyTextBox();
			this.label6 = new System.Windows.Forms.Label();
			this.cbo_tipo_Logradouro = new SIESC_UI.MyComboBox();
			this.label5 = new System.Windows.Forms.Label();
			this.msk_inep = new SIESC_UI.MyMaskedTextBox();
			...
			this.mantenedorTableAdapter = new SIESC_UI.siescDataSetTableAdapters.mantenedorTableAdapter();
			this.regionaisTableAdapter = new SIESC_UI.siescDataSetTableAdapters.regionaisTableAdapter();
			this.btn_limpar = new System.Windows.Forms.Button();
			this.anoTableAdapter1 = new SIESC_UI.siescDataSetTableAdapters.anoTableAdapter();
			this.nivelensinoTableAdapter1 = new SIESC_UI.siescDataSetTableAdapters.nivelensinoTableAdapter();
			...
			this.gpb_endereco.Size = new System.Drawing.Size(684, 265);
			...
			this.btn_localizarcoord.Location = new System.Drawing.Point(5, 13);
			...
			// msk_longitude
			// 
			this.msk_longitude.Location = new System.Drawing.Point(119, 56);
			...
			this.lbl_longitude.Location = new System.Drawing.Point(116, 39);
			...
			// msk_latitude
			// 
			this.msk_latitude.Location = new System.Drawing.Point(12, 56);
			...
			this.btn_funcionarios.Image = global::SIESC_UI.Properties.Resources._1431654656_people;

namespace SIESC_UI.UI.Relatorios
{
	partial class Listas
	{
		...
		private void InitializeComponent()
		{
			...
			this.dsListas1 = new SIESC_BD.DataSets.dsListas();
			this.vw_instituicoesTableAdapter1 = new SIESC_BD.DataSets.dsListasTableAdapters.vw_instituicoesTableAdapter();
			this.vw_autorizacoesTableAdapter1 = new SIESC_BD.DataSets.dsListasTableAdapters.vw_autorizacoesTableAdapter();
			this.vw_funcionariosTableAdapter1 = new SIESC_BD.DataSets.dsListasTableAdapters.vw_funcionariosTableAdapter();
		...
		private SIESC_BD.DataSets.dsListas dsListas1;
		private SIESC_BD.DataSets.dsListasTableAdapters.vw_instituicoesTableAdapter vw_instituicoesTableAdapter1;
		private SIESC_BD.DataSets.dsListasTableAdapters.vw_autorizacoesTableAdapter vw_autorizacoesTableAdapter1;
		private SIESC_BD.DataSets.dsListasTableAdapters.vw_funcionariosTableAdapter vw_funcionariosTableAdapter1;
	}
}

...
using vw_deficientesTableAdapter = SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_deficientesTableAdapter;
using vw_num_encaminhadosTableAdapter = SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_num_encaminhadosTableAdapter;
using vw_origem_solicitacaoTableAdapter = SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_origem_solicitacaoTableAdapter;
...
namespace SIESC_UI.UI
{
	partial class frm_Relatorio_geral
	{
		...
		private void InitializeComponent()
		{
			...
			this.dsRelatorios = new SIESC_BD.DataSets.dsRelatorios();
			this.vw_controlesolicitacoesTableAdapter = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_controlesolicitacoesTableAdapter();
			this.vw_ficha_solicitacaoTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_ficha_solicitacaoTableAdapter();
			this.vw_motivosTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_motivosTableAdapter();
			this.vw_lista_encaminhadosTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_lista_encaminhadosTableAdapter();
			this.vw_alunos_pendentesTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_alunos_pendentesTableAdapter();
			...
			this.dsRelatorios1 = new SIESC_BD.DataSets.dsRelatorios();
			this.vw_alunos_pendentes_infantilTableAdapter1 = new SIESC_BD.DataSets.dsInfantilTableAdapters.vw_alunos_pendentes_infantilTableAdapter();
			this.vw_comparativo_solicitacoes_encaminhamentosTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_comparativo_solicitacoes_encaminhamentosTableAdapter();
			this.vw_solicitacoes_por_mesTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_solicitacoes_por_mesTableAdapter();
			this.zoneamentoTableAdapter1 = new SIESC_BD.DataSets.ds_siescTableAdapters.ZoneamentoTableAdapter();
			this.num_solicitacoesTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.num_solicitacoesTableAdapter();
			this.num_solicitacoes_infantilTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.num_solicitacoes_infantilTableAdapter();
			this.vw_solicitacoes_motivosTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_solicitacoes_motivosTableAdapter();
			this.vw_deficientesTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_deficientesTableAdapter();
			this.vw_num_encaminhadosTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_num_encaminhadosTableAdapter();
			this.vw_origem_solicitacaoTableAdapter1 = new SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_origem_solicitacaoTableAdapter();
		...
		private SIESC_BD.DataSets.dsRelatorios dsRelatorios;

		private SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_controlesolicitacoesTableAdapter
			vw_controlesolicitacoesTableAdapter;

		private Microsoft.Reporting.WinForms.ReportViewer rpt_viewer;

		private SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_ficha_solicitacaoTableAdapter
			vw_ficha_solicitacaoTableAdapter1;

		private SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_motivosTableAdapter vw_motivosTableAdapter1;
		private SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_lista_encaminhadosTableAdapter vw_lista_encaminhadosTableAdapter1;
		private SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_alunos_pendentesTableAdapter vw_alunos_pendentesTableAdapter1;
		...
		private SIESC_BD.DataSets.dsRelatorios dsRelatorios1;
		private SIESC_BD.DataSets.dsInfantilTableAdapters.vw_alunos_pendentes_infantilTableAdapter vw_alunos_pendentes_infantilTableAdapter1;
		private SIESC_BD.DataSets.dsRelatoriosTableAdapters.vw_comparativo_solicitacoes_encaminhamentosTableAdapter
			vw_comparativo_solicitacoes_encaminhamentosTableAdapter1;
		private vw_solicitacoes_por_mesTableAdapter vw_solicitacoes_por_mesTableAdapter1;
		private SIESC_BD.DataSets.ds_siescTableAdapters.ZoneamentoTableAdapter zoneamentoTableAdapter1;
